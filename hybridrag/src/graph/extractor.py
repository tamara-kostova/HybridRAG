...
class NodeExtractor:
    def __init__(self, url:str = 'bolt://localhost:7687',username:str = 'neo4j',password = '',chunk_size:int = 1200,chunk_overlap:int = 200):
        ...
        with open(file='hybridrag/src/graph/extraction_system_prompt.txt', mode='r') as file:
            prompt_content = file.read()

            self.system_prompt = prompt_content

        with open(file='hybridrag/src/graph/extraction_human_prompt.txt', mode ='r') as file: 
            prompt_content = file.read()
